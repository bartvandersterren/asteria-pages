...
# Föhn- en Airco-iconen in het inclusief-blok: eigen, schonere lijnversies.
html = html.replace(
    '<circle cx="8" cy="9" r="5"/><path d="M8 14v6M13 9h6M16 6v6"/>',
    '<path d="M5 8.2 14 7a4.4 4.4 0 0 1 0 10L5 15.8Z"/><path d="M3 7.6h2v8.8H3z"/><circle cx="12" cy="12" r="2.4"/><path d="M9 16.3v3a2.2 2.2 0 0 0 4.4 0v-3"/><path d="M16.8 9.6c2.6.7 2.9 3.3 1.3 4.8"/><path d="M17.4 8.6l1.7 1.7M19.7 8.5 18 10.2"/>')
html = html.replace(
    '<path d="M3 8a4 4 0 018 0v8a4 4 0 008 0M3 8h6M15 16h6"/>',
    '<rect x="3" y="6" width="18" height="7.4" rx="2.2"/><path d="M5.2 11h11.6"/><path d="M17.6 8.3h1.6"/><path d="M7 16.2c.9 1 .9 2.2 0 3.2"/><path d="M11 16.2c.9 1 .9 2.2 0 3.2"/><path d="M15 16.2c.9 1 .9 2.2 0 3.2"/>')
...
BK_CSS += ('\n  .promo__card.care-card { background: #fff; color: #1a1a1a; }\n'
           ...
           '  .pagewm::before { content: \'\'; position: absolute; left: 0; top: 50%; transform: translateY(-50%); width: 100%; aspect-ratio: 598 / 925; background: url(fotos/pattern-asteria-1.webp) no-repeat center / contain; opacity: .2; pointer-events: none; z-index: 2; }\n')
...
UI.update({
 ...
 'care_p':{'nl':'Heeft u een vraag over uw verblijf, een speciale wens of boekt u liever telefonisch? Onze receptie staat dagelijks voor u klaar en denkt graag met u mee — van een vroege check-in of een extra bed tot tips voor de mooiste plekken in Noord-Limburg. Neem gerust contact met ons op, we helpen u graag persoonlijk verder.',
           'en':'Have a question about your stay, a special request, or would you rather book by phone? Our front desk is here for you every day and is happy to help — from an early check-in or an extra bed to tips for the finest spots in North Limburg. Feel free to get in touch; we are glad to assist you personally.',
           'de':'Haben Sie eine Frage zu Ihrem Aufenthalt, einen besonderen Wunsch oder buchen Sie lieber telefonisch? Unsere Rezeption ist täglich für Sie da und denkt gerne mit — vom frühen Check-in oder einem Zustellbett bis hin zu Tipps für die schönsten Orte in Nord-Limburg. Kontaktieren Sie uns einfach, wir helfen Ihnen gerne persönlich weiter.'},
...
def build_overview(lang):
    ...
    /* Achtergrond-ritmiek: alternerende cream-banden (wit / #f6f5f3) */
...
# Care-CTA onder de FAQ (comfort NL); sluit eerst de watermerk-wrapper
if 'care-section' not in comfort:
    comfort = comfort.replace('<!-- ══ STICKY', '</div>\n\n' + care_block('nl') + '\n\n<!-- ══ STICKY', 1)
